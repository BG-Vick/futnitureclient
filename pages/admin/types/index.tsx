...
import { createType, deleteType, fetchTypes } from '@/store/typesApi'
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              text-gray-900 text-sm rounded-lg p-2.5
                ...
                <button
                  ...
                  disabled={!isValid}
                  className={clsx(
                    isValid ? 'bg-blue-500 hover:bg-blue-800' : 'bg-gray-200',
                    'text-white mt-2  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center'
                  )}
                >
                  Применить
                </button>
